...
# ────────────────────────────────
# Ejecucion del seed.py
# python manage.py shell < seeds/seed.py
# En caso de no funcionar, probar en el Command Prompt
# -----------Ambos-----------------------------
# chcp 65001
# python -X utf8 manage.py shell < seeds\seeds.py
# ────────────────────────────────